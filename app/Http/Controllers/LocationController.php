...
class RegionController extends Controller
{
    ...
    {
        return view('location.create')->with([
    ...
    public function update(Request $request, $id)
	{
		...
		$mo->save();
		return redirect(route('location.index'))->with('message',"Информация по региону $mo->name изменена");
	}
    ...
    public function destroy($id)
    {
        $mo = $this->region->find($id);
		$mo->delete();
		return back()->with('message',"Информация по региону $mo->name удалена");
    }
}
