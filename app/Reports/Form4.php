...
{
    public static function getForm4ByGender($startdate, $enddate, $region) //Форма 4 по полу
    {
	...
	public static function getForm4ByComparison($startdate, $enddate, $region) //Форма 4 в сравнении
    {
