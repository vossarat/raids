<input id="id" type="hidden" class="form-control" name="id" value="<?php echo e(isset($viewdata->id) ? $viewdata->id : old('id')); ?>"> 	
...
<div class="form-group">
	<div class="<?php echo e($errors->has('number') ? ' has-error' : ''); ?>">		
		...
		<div class="col-md-2">
			<input id="number" type="text" class="form-control" name="number" value="<?php echo e($viewdata->number); ?>">
...
<div class="form-group">
	<div class="<?php echo e($errors->has('birthday') ? ' has-error' : ''); ?>"> 
		...
		<div class="col-md-2">
		<input id="birthday" type="text" class="form-control" name="birthday" value="<?php echo e(isset($viewdata->birthday) ? '01-01-'.$viewdata->birthday:''); ?>">
