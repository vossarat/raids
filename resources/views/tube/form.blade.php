...
<div class="form-group">{{-- number field IIN field --}}
	<div class="{{ $errors->has('number') ? ' has-error' : '' }}">		
		...
		<div class="col-md-2">
			<input id="number" type="text" class="form-control" name="number" value="{{$viewdata->number }}">
...
<div class="form-group">
	<div class="{{ $errors->has('birthday') ? ' has-error' : '' }}"> {{-- birthday field --}}
		...
		<div class="col-md-2">
		<input id="birthday" type="text" class="form-control" name="birthday" value="{{ isset($viewdata->birthday) ? '01-01-'.$viewdata->birthday:'' }}">
